...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    TOKEN_EXISTS = 302,            /* EXISTS  */
    TOKEN_LE = 303,                /* LE  */
    TOKEN_GE = 304,                /* GE  */
    TOKEN_NE = 305,                /* NE  */
    TOKEN_IDENTIFIER = 306,        /* IDENTIFIER  */
    TOKEN_STRING_LITERAL = 307,    /* STRING_LITERAL  */
    TOKEN_INTEGER_LITERAL = 308,   /* INTEGER_LITERAL  */
    TOKEN_FLOAT_LITERAL = 309,     /* FLOAT_LITERAL  */
    TOKEN_UMINUS = 310             /* UMINUS  */
  };
