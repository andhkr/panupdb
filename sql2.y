...
null_predicate
	:	row_value_constructor IS opt_nt_195 NULL
	;
...
assertion_definition
	:	CREATE ASSERTION constraint_name assertion_check opt_nt_247
	;
...
character_set_definition
	:	CREATE CHARACTER SET character_set_name opt_nt_248 character_set_source opt_nt_249
	;
...
translation_collation
	:	TRANSLATION translation_name opt_nt_250
	;
...
collation_definition
	:	CREATE COLLATION collation_name FOR character_set_specification FROM collation_source opt_nt_251
	;
...
add_column_definition
	:	ADD opt_nt_252 column_definition
	;
...
alter_column_definition
	:	ALTER opt_nt_253 column_name alter_column_action
	;
...
drop_column_definition
	:	DROP opt_nt_254 column_name drop_behaviour
	;
...
revoke_statement
	:	REVOKE opt_nt_255 privileges ON object_name FROM grantee opt_nt_256 drop_behaviour
	;
...
fetch_statement
	:	FETCH opt_nt_259 cursor_name INTO fetch_target_list
	;
...
fetch_orientation
	...
	|	FIRST
	|	LAST
	|	seq_nt_261 simple_value_specification
	;
...
fetch_target_list
	:	target_specification opt_nt_262
	;
...
select_statement_single_row
	:	SELECT opt_nt_265 select_list INTO select_target_list table_expression
	;
...
select_target_list
	:	target_specification opt_nt_266
	;
...
delete_statement_searched
	:	DELETE FROM table_name opt_nt_269
	;
...
update_statement_searched
	:	UPDATE table_name SET set_clause_list opt_nt_274
	;
...
set_transaction_statement
	:	SET TRANSACTION transaction_mode opt_nt_275
	;
...
set_constraints_mode_statement
	:	SET CONSTRAINTS constraint_name_list seq_nt_278
	;
...
connection_target
	:	sql_server_name opt_nt_284 opt_nt_285
	|	DEFAULT
	;
...
allocate_descriptor_statement
	:	ALLOCATE DESCRIPTOR descriptor_name opt_nt_286
	;
...
descriptor_name
	:	opt_nt_287 simple_value_specification
	;
...
set_descriptor_information
	:	set_count
	|	VALUE item_number set_item_information opt_nt_288
	;
...
get_descriptor_information
	:	get_count
	|	VALUE item_number get_item_information opt_nt_291
	;
...
extended_statement_name
	:	opt_nt_294 simple_value_specification
	;
...
using_descriptor
	:	seq_nt_295 SQL DESCRIPTOR descriptor_name
	;
...
describe_output_statement
	:	DESCRIBE opt_nt_296 sql_statement_name using_descriptor
	;
...
execute_statement
	:	EXECUTE sql_statement_name opt_nt_297 opt_nt_298
	;
...
using_arguments
	:	seq_nt_299 argument opt_nt_300
	;
...
allocate_cursor_statement
	:	ALLOCATE extended_cursor_name opt_nt_303 opt_nt_304 CURSOR FOR extended_statement_name
	;
...
extended_cursor_name
	:	opt_nt_305 simple_value_specification
	;
...
dynamic_open_statement
	:	OPEN dynamic_cursor_name opt_nt_306
	;
...
dynamic_fetch_statement
	:	FETCH opt_nt_307 dynamic_cursor_name
	;
...
dynamic_update_statement_positioned
	:	UPDATE table_name SET set_clause opt_nt_309 WHERE CURRENT OF dynamic_cursor_name
	;
...
statement_information
	:	statement_information_item opt_nt_312
	;
...
condition_information
	:	EXCEPTION condition_number condition_information_item opt_nt_315
	;
...
lst_nt_320
	...
	|	lst_nt_320 host_variable_definition
	;
...
embedded_sql_declare_section
	:	embedded_sql_begin_declare opt_nt_318 opt_nt_319 embedded_sql_end_declare
...
embedded_sql_begin_declare
	:	sql_prefix BEGIN DECLARE SECTION opt_nt_321
	;
...
ada_variable_definition
	:	ada_host_identifier opt_nt_322 colon ada_type_specification opt_nt_325
	;
...
opt_nt_326
	:	/* Nothing */
	|	CHARACTER SET opt_nt_327 character_set_specification
	;

ada_qualified_type_specification
	:	SQL_STANDARD.CHAR opt_nt_326 left_paren 1 double_period length right_paren
...
c_variable_definition
	:	opt_nt_328 opt_nt_329 c_variable_specification semicolon
	;
...
seq_nt_333
	:	comma c_host_identifier opt_nt_334
	;

lst_nt_335
	:	seq_nt_333
	|	lst_nt_335 seq_nt_333
	;
...
c_numeric_variable
	:	seq_nt_330 c_host_identifier opt_nt_331 opt_nt_332
	;
...
opt_nt_336
	:	/* Nothing */
	|	CHARACTER SET opt_nt_337 character_set_specification
	;
...
seq_nt_340
	:	comma c_host_identifier c_array_specification opt_nt_341
	;

lst_nt_342
	:	seq_nt_340
	|	lst_nt_342 seq_nt_340
	;
...
c_character_variable
	:	char opt_nt_336 c_host_identifier c_array_specification opt_nt_338 opt_nt_339
	;
...
opt_nt_343
	:	/* Nothing */
	|	CHARACTER SET opt_nt_344 character_set_specification
	;
...
seq_nt_347
	:	comma c_host_identifier c_array_specification opt_nt_348
	;

lst_nt_349
	:	seq_nt_347
	|	lst_nt_349 seq_nt_347
	;
...
c_varchar_variable
	:	VARCHAR opt_nt_343 c_host_identifier c_array_specification opt_nt_345 opt_nt_346
	;
...
seq_nt_352
	:	comma c_host_identifier c_array_specification opt_nt_353
	;

lst_nt_354
	:	seq_nt_352
	|	lst_nt_354 seq_nt_352
	;
...
c_bit_variable
	:	BIT c_host_identifier c_array_specification opt_nt_350 opt_nt_351
	;
...
embedded_sql_end_declare
	:	sql_prefix END DECLARE SECTION opt_nt_355
	;
...
lst_nt_358
	:	host_variable_definition
	|	lst_nt_358 host_variable_definition
	;
...
embedded_sql_mumps_declare
	:	sql_prefix BEGIN DECLARE SECTION opt_nt_356 opt_nt_357 END DECLARE SECTION sql_terminator
	;
...
embedded_sql_statement
	:	sql_prefix statement_or_declaration opt_nt_359
	;
...
preparable_dynamic_delete_statement_positioned
	:	DELETE opt_nt_361 WHERE CURRENT OF cursor_name
	;
...
preparable_dynamic_update_statement_positioned
	:	UPDATE opt_nt_362 SET set_clause WHERE CURRENT OF cursor_name
	;
